...
<script type="text/javascript">
	...
	function onResponse() {
		...
		//创建表格
		strText = "<table border='1'><tr><th>Id</th><th>Title</th><th>Content</th><th>Time</th></tr>";
...
<body>
	<div id="copy">
		<button onclick="loadXMLDoc('../AfficheJsonServlet')">获取json</button>
	</div>
	<a href="../table/affichetable.jsp">表格</a>
</body>
</html>