...
<body>
	<div>
		...
		<div class="page-header">
			<h1 id="affiche-table">Affiche Table</h1>
		</div>
		...
		<div class="bs-example">
			...
			<table id="table-style" data-toggle="table"
				data-url="../AfficheJsonServlet" data-sort-name="name"
				data-sort-order="desc" data-height="246" data-pagination="true">
				<thead>
					<tr>
						<th data-field="state" data-checkbox="true"></th>
						<th data-field="id" data-align="right" data-sortable="true">Affiche ID</th>
						<th data-field="title" data-align="center" data-sortable="true">Affiche Title</th>
						<th data-field="content" data-align="center" data-sortable="true">Affiche Content</th>
						<th data-field="time" data-align="" data-sortable="true">Affiche Time</th>
					</tr>
				</thead>
			</table>
