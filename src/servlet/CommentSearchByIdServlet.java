...
/**
 * Servlet implementation class CommentSearchByIdServlet
 */
@WebServlet(description = "CommentSearchByIdServlet", urlPatterns = { "/CommentSearchByIdServlet" })
public class CommentSearchByIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommentSearchByIdServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "select * from comment where ID_=" + id;	//查询操作
