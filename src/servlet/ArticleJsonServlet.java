...
/**
 * Servlet implementation class ArticleJsonServlet
 */
@WebServlet(description = "ArticleJsonServlet", urlPatterns = { "/ArticleJsonServlet" })
public class ArticleJsonServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String sql = "select * from article "; // 查询操作
			...
			for (int i = 0; i < list2.size(); i++) { // 将数据转换成json格式
				...
				jsonStringer.key("type_id").value(blog.getType_id());
